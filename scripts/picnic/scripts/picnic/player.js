class Player {
    constructor(game){
      ...
      this.barSize;
      this.charging;
      this.image = document.getElementById('player_mayo');
      this.frameY;
    
    }
    draw(){
      
      this.game.ctx.drawImage(this.image, 0, this.frameY * this.spriteHeight, 750, 750, this.x, this.y, this.width, this.height);
      if (this.game.debug){
    ...
    wingsUp(){
    if (!this.charging) this.frameY = 8;
    }
    wingsCharge(){
    this.frameY = 13;
    }
